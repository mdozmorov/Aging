...
library(knitr) 
opts_chunk$set(cache.path='cache/', fig.path='img/', cache=F, tidy=T, fig.keep='high', dpi=300,  echo=F, autodep=T, width=200, warning=FALSE, comment=NA)
...
---
```{r fig3a-enrichment_histone, fig.height=5.5, dev=dev.out}
#dev.off()
...
---
```{r fig3b-enrichment_tfbs, fig.height=5.5, dev=dev.out}
#dev.off()
...
C) Chromatin states
---
```{r fig3c-enrichment_chromstates, fig.height=5.5, dev=dev.out}
#dev.off()
...
```{r fig4-pos-neg_episimilarity, fig.height=6, dev=dev.out}
